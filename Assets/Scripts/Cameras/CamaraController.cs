...
{
	[SerializeField] private Transform palyerCameraTrasnform = null;
	...
	{
		palyerCameraTrasnform.gameObject.SetActive(true);
	...
	{
		Vector3 pos = palyerCameraTrasnform.position;
		...
		palyerCameraTrasnform.position = pos;
	}
